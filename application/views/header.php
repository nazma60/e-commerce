...
<head>
    ...
    $(document).ready.function(){
        $("#search").autocomplete({
            source: <?php echo base_url('search/product_search');?>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="<?php echo base_url('homepage_controller');?>"><img src="<?php echo base_url('images/home/logo.png')?>" height="70" alt=""/></a>
                    </div>
    ...
    <div class="header-bottom"><!--header-bottom-->
        <div class="container">
            <div class="row">
                                        ...
                                        <ul role="menu" class="sub-menu">
                                            <?php foreach ($data as $sub) { ?>
                                                <?php if ($sub['parent_id'] == $category['id']) { ?>
                                                    <li><a href="<?php echo base_url('category_controller/child_menu/'.$sub['id'])?>"><?php echo ucwords($sub['name']); ?></a></li>
                ...
                <div class="col-sm-3">
                    <form id="search" class="navbar-form search_box pull-right" action="<?php echo base_url('search/search_result') ?>" method="get">
                        <input name="query" type="search" id="txtinput" placeholder="Search...">
                    </form>
